...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-rdhk-fg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-rdhk-fg.containers.anotherwebservice.com/
...
```
git clone git@github.com:VictorFilimonov/container-rdhk-fg.git
```
...
```
docker attach container-rdhk-fg
```
